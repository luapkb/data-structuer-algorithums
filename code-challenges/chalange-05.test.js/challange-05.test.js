...
const listFoods = (recipe) => {
  let result = [];
  let timmy = recipe.ingredients;
  // timmy.slice(timmy.indexOf())
  timmy.forEach(foods => {

    let firstSlice = foods.slice(foods( -8));
    let seccondSlice = firstSlice.(food.indexOf(' ') + 1);
